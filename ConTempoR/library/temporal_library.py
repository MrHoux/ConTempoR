from ConTempoR.library.temporal_annotator.date_annotator import RegexpAnnotator
from ConTempoR.library.temporal_annotator.ordinal_annotator import ordinal_annotation
