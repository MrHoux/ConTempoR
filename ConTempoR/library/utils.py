...
def filter_ask_number_questions(instance):
    if "how many" in instance["pseudo_question_construction"].lower():
        return True


def filter_question_having_year(instance):
    words = nltk.word_tokenize(instance["pseudo_question_construction"].lower())
    for word in words:
...
def filter_ask_time_questions(instance):
    words = instance["pseudo_question_construction"].lower().split()
    if "during what" in instance["pseudo_question_construction"].lower():
        return True
    if "during which" in instance["pseudo_question_construction"].lower():
        return True
    if "what year" in instance["pseudo_question_construction"].lower() and "what yearly" not in instance[
        "pseudo_question_construction"].lower():
        return True
    elif "which month" in instance["pseudo_question_construction"].lower():
        return True
    elif "which year" in instance["pseudo_question_construction"].lower() and "which yearly" not in instance[
        "pseudo_question_construction"].lower():
        return True
    elif "which date" in instance["pseudo_question_construction"].lower():
        return True
    elif "what date" in instance["pseudo_question_construction"].lower():
        return True
    elif "what time" in instance["pseudo_question_construction"].lower():
        return True
    elif "when" in words:
...
def filter_questions_have_strange_char(instance):
    if "??" in instance["pseudo_question_construction"].lower():
        return True
    if "(" in instance["pseudo_question_construction"].lower() and ")" not in instance["pseudo_question_construction"].lower():
        print(instance["pseudo_question_construction"])
        return True
